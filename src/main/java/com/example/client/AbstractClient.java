...
// INSTANCE METHODS *************************************************
	 ...
	 * should still perform the general function of sending to server, by calling
	 * the <code>super.sendToServer()</code> method perhaps after some kind of
	 * filtering is done.
	 *
...
// METHODS DESIGNED TO BE OVERRIDDEN BY CONCRETE SUBCLASSES ---------
	 ...
	 * that is reading messages from the server. The method may be overridden by
	 * subclasses. Most exceptions will cause the end of the reading thread except
	 * for <code>ClassNotFoundException<\code>s received when an object of
