...
//INSTANCE METHODS *************************************************
	 ...
	 * should still perform the general function of sending to client, by calling
	 * the <code>super.sendToClient()</code> method perhaps after some kind of
	 * filtering is done.
	 *
...
//METHODS DESIGNED THAT MAY BE OVERRIDDEN BY SUBCLASSES ---------
	 ...
	 * <code>handleMessageFromClient()</code> of <code>AbstractServer</code> will
	 * also be called after. The default implementation simply returns true.
	 *
